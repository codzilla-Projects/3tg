<?php get_header(); ?>
                    ...
                    <div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 650, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'navigation' : {'arrows': { 'enable': true, 'style': 'arrows-style-1 arrows-big arrows-dark' }, 'bullets': {'enable': false, 'style': 'bullets-style-1 bullets-color-primary', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
                        <ul>
                            <li data-transition="fade">
                                <img src="<?php echo SH_URL; ?>assets/img/slides/36.png"  
                                    alt=""
                                ...
                                <div class="tp-caption"
                                    ...
                                    data-transform_idle="opacity:0.5;s:500;"><img src="<?php echo SH_URL; ?>assets/img/slides/slide-title-border-light.png" alt=""></div>
                                ...
                                <div class="tp-caption d-none d-md-block"
                                    ...
                                    data-y="center" data-voffset="['-33','-33','-33','-55']"><img src="<?php echo SH_URL; ?>assets/img/slides/slide-blue-line.png" alt=""></div>
                            ...
                            <li data-transition="fade">
                                ...
                                <img src="<?php echo SH_URL; ?>assets/img/slides/35.png"  
                                    alt=""
                                ...
                                <div class="tp-caption font-weight-light text-color-dark"
                                    ...
                                    style="color: #b5b5b5;">3TG is a Huge success in the of one of the world's largest MarketPlace.</div>
              ...
              <section class="section section-height-3 bg-color-grey-scale-1 m-0 border-0">
                    <div class="container">
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-sm-8 col-md-6 col-lg-4 offset-sm-4 offset-md-4 offset-lg-2 mt-sm-5" style="top: 1.7rem;">
                                <img src="<?php echo SH_URL; ?>assets/img/generic/12.png" class="img-fluid position-absolute d-none d-sm-block appear-animation" data-appear-animation="expandIn" data-appear-animation-delay="300" style="top: 10%; left: -50%;" alt="" />
                                <img src="<?php echo SH_URL; ?>assets/img/generic/5.png" class="img-fluid position-absolute d-none d-sm-block appear-animation" data-appear-animation="expandIn" style="top: -33%; left: -29%;" alt="" />
                                <img src="<?php echo SH_URL; ?>assets/img/generic/34.png" class="img-fluid position-relative appear-animation mb-2" data-appear-animation="expandIn" data-appear-animation-delay="600" alt="" />
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="row py-lg-5 my-5">
                        <div class="col-lg-7 pr-lg-5 mb-5 mb-lg-0">
                            <h2 class="font-weight-bold mb-4">Our Great Services</h2>
                            ...
                            <div class="row">
                                <div class="col-6 mb-4">
                                    <div class="appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="200">
                                        ...
                                        <h4 class="font-weight-bold text-5 pl-1 mb-2">Visa Extraction</h4>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="600">
                                        ...
                                        <h4 class="font-weight-bold text-5 pl-1 mb-2">Shipping</h4>
                                        <p class="pl-1">Lorem ipsum dolor sit amet, coctetur adipiscing elit.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6 mb-4 mb-sm-0">
                                    <div class="appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="1000">
                                        ...
                                        <h4 class="font-weight-bold text-5 pl-1 mb-2">Ticket Reservation</h4>
                                        <p class="pl-1">Lorem ipsum dolor sit amet, coctetur adipiscing elit.</p>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="1400">
                                        ...
                                        <h4 class="font-weight-bold text-5 pl-1 mb-2">Hotel Reservation</h4>
                                        <p class="pl-1">Lorem ipsum dolor sit amet, coctetur adipiscing elit.</p>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="parallax section section-height-3 section-parallax m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="<?php echo SH_URL; ?>assets/img/parallax/parallax-corporate-9-1.jpg">
                <div class="container">
                                    ...
                                    <div class="row counters counters-lg counters-text-dark">
                                        ...
                                        <div class="col-md-6 mb-5">
                                            <div class="counter">
                                                ...
                                                <label class="opacity-8 font-weight-normal text-4">Pro Consultants</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="counter">
                                                ...
                                                <label class="opacity-8 font-weight-normal text-4">Sucessfull Cases</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section class="parallax section section-text-light section-parallax section-angled section-angled-reverse overlay overlay-show overlay-op-8 my-0" data-plugin-parallax data-plugin-options="{'speed': 2.5}"data-image-src="<?php echo SH_URL; ?>assets/img/generic/19.png">
                                            ...
                                            <div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="400">
                                                ...
                                                <div class="feature-box-info">
                                                    <span class="text-color-light line-height-3 opacity-7">HEADQUARTERS</span>
                                                     <h3 class="text-color-primary font-weight-bold text-8 pb-1 mb-4">New York</h3>
                                                     <ul class="list list-unstyled text-color-light text-default opacity-9 pb-1 mb-4">
                                                        <li>3TG Template 123</li>
                                                        <li>3TG Blvd, Suite</li>
                                                        <li>Call: <a href="tel:+0123456789" class="text-color-light text-decoration-none">123-456-7890</a></li>
                                                        <li>Email: <a href="mailto:you@domain.com" class="text-color-light text-decoration-none">info@3TG.com</a></li>
                                                     </ul>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
                                                <div class="feature-box-info">
                                                    ...
                                                    <h3 class="text-color-primary font-weight-bold text-8 pb-1 mb-4">Detroit</h3>
                                                    <ul class="list list-unstyled text-color-light text-default opacity-9 pb-1 mb-4">
                                                         <li>3TG Template 123</li>
                                                         <li>3TG Blvd, Suite</li>
                                                         <li>Call: <a href="tel:+0123456789" class="text-color-light text-decoration-none">123-456-7890</a></li>
                                    ...
                                    <div>
                                        <div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-quotes-dark mb-0">
                                            <div class="testimonial-author">
                                                <img src="<?php echo SH_URL; ?>assets/img/clients/client-1.jpg" class="img-fluid rounded-circle" alt="">
                                            </div>
                                            <blockquote>
